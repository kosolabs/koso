...
<div
  use:height
  class={cn(
    "max-sm-standalone-margin fixed bottom-0 left-0 z-10 flex w-full items-center overflow-x-scroll px-2 py-1 backdrop-blur-sm max-sm:border-t sm:sticky sm:top-0 sm:gap-2 sm:border-b",
  )}
>
