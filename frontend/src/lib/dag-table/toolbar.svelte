...
<div
  use:height
  class={cn(
    "max-sm-standalone-margin left-0 z-10 flex w-full items-center overflow-x-scroll px-2 py-1 backdrop-blur-xs max-sm:fixed max-sm:bottom-0 max-sm:border-t sm:sticky sm:top-0 sm:gap-2 sm:border-b",
  )}
>
