<script lang="ts">
  ...
  const registry = new KeyHandlerRegistry([
    [KeyBinding.INSERT_NODE, { func: insert }],
    [KeyBinding.REMOVE_NODE, { func: remove }],
    [KeyBinding.EDIT_NODE, { func: edit }],
    [KeyBinding.CANCEL_SELECTION, { func: unselect }],
    [KeyBinding.INSERT_CHILD_NODE, { func: insertChild }],
    [KeyBinding.MOVE_NODE_UP, { func: moveUp }],
    [KeyBinding.MOVE_NODE_DOWN, { func: moveDown }],
    [KeyBinding.MOVE_NODE_ROW_UP, { func: moveRowUp }],
    [KeyBinding.MOVE_NODE_ROW_DOWN, { func: moveRowDown }],
    [KeyBinding.INDENT_NODE, { func: indent }],
    [KeyBinding.INDENT_NODE_SHIFT, { func: indent }],
    [KeyBinding.UNDENT_NODE, { func: undent }],
    [KeyBinding.UNDENT_NODE_SHIFT, { func: undent }],
    [KeyBinding.EXPAND_NODE, { func: expand }],
    [KeyBinding.COLLAPSE_NODE, { func: collapse }],
    [KeyBinding.SELECT_NEXT_NODE, { func: selectNext }],
    [KeyBinding.SELECT_PREV_NODE, { func: selectPrev }],
    [KeyBinding.UNDO, { func: undo }],
    [KeyBinding.REDO, { func: redo }],
  ]);
